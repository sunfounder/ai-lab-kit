...
In this lesson, you will build a **gravity-referenced 3D cube** displayed on a 128×64 SSD1306 OLED, driven by an **IMU**.  
...
1. **IMU Initialization**
   ...
   The script creates an ``IMU`` instance from the Fusion HAT+ module.  
   The accelerometer provides raw X, Y, Z acceleration values in units of m/s².
