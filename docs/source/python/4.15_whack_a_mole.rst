...
.. .. image:: img/fzz/4.15_whack_a_mole_sch.png
..    :width: 80%
..    :align: center
...
#. Create and activate a virtual environment:
   ...
   .. code-block:: shell
      ...
      cd ~
      python3 -m venv 4.15_whack_a_mole_env --system-site-packages
      source 4.15_whack_a_mole_env/bin/activate
...
#. Run the game from the ``ai-lab-kit`` directory:
   ...
   .. code-block:: shell
      ...
      sudo ~/4.15_whack_a_mole_env/bin/python3 4.15_WhackAMole.py
