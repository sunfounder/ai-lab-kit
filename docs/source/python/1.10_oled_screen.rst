...
..       cd ~
..       python3 -m venv 1.10_oled_env --system-site-packages
..       source 1.10_oled_env/bin/activate
   
..    .. note::
..       It is recommended to create a separate virtual environment for each project to avoid dependency conflicts.
...
#. All example programs are included in the ``ai-lab-kit`` directory. Run the OLED example as follows:
