...
The circuit connects the OLED display to the Raspberry Pi's I2C interface. The SSD1306 typically requires four connections: VCC (3.3V), GND, SCL (clock), and SDA (data). Some displays may also have a reset pin, but it's often not required for basic operation.

.. image:: img/fzz/1.8_oled_sch.png
