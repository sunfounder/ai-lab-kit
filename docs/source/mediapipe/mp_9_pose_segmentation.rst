...
.. code-block:: bash
   ...
   sudo ~/mediapipe_env/bin/python3 ~/ai-lab-kit/mediapipe/mp_pose_segmentation.py

If you want to use MediaPipe Pose with a recorded video, you can run the following command:

.. code-block:: bash

   sudo ~/mediapipe_env/bin/python3 ~/ai-lab-kit/mediapipe/mp_pose_segmentation_video.py
